...
|  5   | Attach a lens tube (SM1L03) to couplers (SM1T010) on one side.| ![Step 5](Instruction_Media/step_5.gif)|
|  6   | Screw in one side of the lens tube into the threading ring (SM2A6) screwed into the large end of the galvos.| ![Step 6](Instruction_Media/step_6.jpg)|
|  7   | Screw in ER05 rods into the galvo housing.| ![Step 7](Instruction_Media/step_7.jpg)|
|  8   | Connect the KC1B/M and the galvo housing with a cage plate inserting the rods in the holes of the cage plate (CP33T/M), and tighten the rods into place with the side screws.| ![Step 8](Instruction_Media/step_8.jpg)|
|  9   | Insert your dichroic filter into the cage cube (CM1-DCH/M). There are small black screws to take out the base of the cage cube that has pinchable parts which move the clamp for the mirrors outwards. Gently place the dichroic filter in the correct orientation (the one that reflects more light should end up facing the galvos) after pinching to make room for the mirror, and release after properly placed. Screw the base plate back into the rest of the cage cube.| ![Step 9](Instruction_Media/step_9.gif) ![Step 9 Continued](Instruction_Media/step_9_pt2.gif)|
<<<<<<< HEAD
|  10  | Attach another lens tube (SM05L03) into the side of the cage cube where the reflective part would face the galvos. Snap on a cap (SM1EC2B) on the other side of the cage cube to prevent light escaping.| ![Step 10](Instruction_Media/step_10.jpg)|
|  11  | Take a lens tube (SM1L10), and remove one threading ring with an SM1 lens tool. Insert two lens (the set with the larger focal distance) carefully with the SM1 lens tube, with the convex (curved) sides of each lens touching each other. The depth at which the lens should be depends on the lens combination used and the distance this should be from the tube lens, which is all ultimately dependent on the distance the setup will be from your mouse. Put the threading ring back in.| ![Step 11](Instruction_Media/step_11.gif)|
=======
|  10  | Attach another lens tube (SM1L03) into the side of the cage cube where the reflective part would face the galvos. Snap on a cap (SM1EC2B) on the other side of the cage cube to prevent light escaping.| ![Step 10](Instruction_Media/step_10.jpg)|
|  11  | Take a lens tube (SM1L10), and remove one threading ring with an SM1 lens tool. Insert two lens (the set with the larger focal distance) carefully with the SM1 lens tube, with the convex (curved) sides of each lens touching each other. The depth at which the lens should be depends on the lens combination used and the distance this should be from the tube lens. Put the threading ring back in.|            |
>>>>>>> 108c0688f3611552bc5949c027e7fb6f4a801fba
